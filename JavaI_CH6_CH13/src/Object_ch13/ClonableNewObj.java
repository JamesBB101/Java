...
public class ClonableNewObj implements Cloneable {
	...
	public static void main(String[] args) {
		ClonableNewObj myShirt = new ClonableNewObj();
		ClonableNewObj yourShirt = new ClonableNewObj();
		...
		try { // 使用.clone()要implements Cloneable
			myShirt = (ClonableNewObj) yourShirt.clone(); // 創造一個新位置的值
