...
public class queen2 {
	...
	public static ArrayList modifyqlist2(int i, ArrayList qlist){
		ArrayList<Integer> qlist2 = new ArrayList<Integer>(qlist.size());
		qlist2.addAll(qlist);
		qlist2.add(i);
		return qlist2;
	}
	...
	public static void queen(ArrayList list, int step, ArrayList qlist){
		if (step == 8){
			total += 1;
...
//				print(modifylist2(i, list));
				queen(modifylist2(i, list), step2, modifyqlist2(q, qlist));
			}			
		}
	}//queen結尾
